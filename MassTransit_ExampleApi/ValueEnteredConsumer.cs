...
namespace MassTransit_ExampleApi
{
    ...
    public class ValueEnteredConsumer : IConsumer<IValueEntered>
    {
        ...
        public ValueEnteredConsumer(IServiceProvider provider, SimpleTransient transient, SimpleScoped scoped, IExchangeIdHelper exchangeIdHelper, SimpleHttpProxy proxy)
        {
            _provider = provider;
